  ...
  <div id="page-wrapper">
	...
	<div class="col-sm-3 pull-right">
               ...
               <div class="image-upload">
					...
					<img src="../images/down.jpg" class="img-responsive img-thumbnail" onchange="showImage1.call(this)" style="min-width:50px;max-width:50px;max-height:50px;" id="image1"/>
					</label>
	...
	<div class="col-sm-3 pull-right">
               ...
               <div class="image-upload">
					<label for="file-input">
					<img src="../images/down.jpg" class="img-responsive img-thumbnail" onchange="showImage2.call(this)" style="min-width:50px;max-width:50px;max-height:50px;" id="image2"/>
					</label>
...
<fieldset class="scheduler-border">
	...
	<div class="col-sm-3 pull-right">
               ...
               <div class="image-upload">
					<label for="file-input">
					<img src="../images/down.jpg" class="img-responsive img-thumbnail" onchange="showImage3.call(this)" style="min-width:50px;max-width:50px;max-height:50px;" id="image3"/>
					</label>
...
<fieldset class="scheduler-border">
	...
	<div class="col-sm-3 pull-right">
               ...
               <div class="image-upload">
					<label for="file-input">
					<img src="../images/down.jpg" class="img-responsive img-thumbnail" onchange="showImage4.call(this)" style="min-width:50px;max-width:50px;max-height:50px;" id="image4"/>
					</label>
...
<fieldset class="scheduler-border">
	...
	<div class="col-sm-3 pull-right">
               ...
               <div class="image-upload">
					<label for="file-input">
					<img src="../images/down.jpg" class="img-responsive img-thumbnail" onchange="showImage5.call(this)" style="min-width:50px;max-width:50px;max-height:50px;" id="image5"/>
					</label>
...
<fieldset class="scheduler-border">
	...
	<div class="col-sm-3 pull-right">
               ...
               <div class="image-upload">
					<label for="file-input">
					<img src="../images/down.jpg" class="img-responsive img-thumbnail" onchange="showImage6.call(this)" style="min-width:50px;max-width:50px;max-height:50px;" id="image6"/>
					</label>
