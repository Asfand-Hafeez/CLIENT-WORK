    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="text-transform:capitalize" >Hi !Student:<?php echo $data['name'] ?></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-check-square-o fa-fw"></i> All Applied Programs</a>
                        </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
						 ...
						 <li>
                            <a href="#"><i class="fa fa-share fa-fw"></i> Submit Application</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
